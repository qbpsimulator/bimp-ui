...
export interface ElementKPIType extends _ElementKPIType { constructor: { new(): ElementKPIType }; }
...
export interface HistogramDataType extends _HistogramDataType { constructor: { new(): HistogramDataType }; }
...
interface HistogramDataTypeValuesType extends _HistogramDataTypeValuesType { constructor: { new(): HistogramDataTypeValuesType }; }
...
export interface ProcessKPIType extends _ProcessKPIType { constructor: { new(): ProcessKPIType }; }
...
export interface ResourceKPIType extends _ResourceKPIType { constructor: { new(): ResourceKPIType }; }
...
export interface ResultsType extends _ResultsType { constructor: { new(): ResultsType }; }
...
interface ResultsType_2 extends _ResultsType_2 { constructor: { new(): ResultsType_2 }; }

/** Simulation error string */
export type SimulationError = ("INVALID_INPUT" | "SIMULATION_ERROR" | "IO_ERROR");
interface _SimulationError extends Primitive._string { content: SimulationError; }
...
interface SimulationHistogramResponseType extends _SimulationHistogramResponseType { constructor: { new(): SimulationHistogramResponseType }; }

interface _SimulationKPIResponseType extends _SimulationKPIType {}
interface SimulationKPIResponseType extends _SimulationKPIResponseType { constructor: { new(): SimulationKPIResponseType }; }
...
export interface SimulationKPIType extends _SimulationKPIType { constructor: { new(): SimulationKPIType }; }
...
interface SimulationKPITypeElementsType extends _SimulationKPITypeElementsType { constructor: { new(): SimulationKPITypeElementsType }; }

interface _SimulationKPITypeResourcesType extends BaseType {
	resource?: ResourceKPIType[];
}
interface SimulationKPITypeResourcesType extends _SimulationKPITypeResourcesType { constructor: { new(): SimulationKPITypeResourcesType }; }
...
interface SimulationSimulatorStatsResponseType extends _SimulationSimulatorStatsResponseType { constructor: { new(): SimulationSimulatorStatsResponseType }; }
...
export interface SimulationSimulatorStatsType extends _SimulationSimulatorStatsType { constructor: { new(): SimulationSimulatorStatsType }; }
...
interface _SimulationStatus extends Primitive._string { content: SimulationStatus; }
...
interface SimulationStatusResponseType extends _SimulationStatusResponseType { constructor: { new(): SimulationStatusResponseType }; }
...
interface StartSimulationRequestType extends _StartSimulationRequestType { constructor: { new(): StartSimulationRequestType }; }
...
interface StartSimulationResponseType extends _StartSimulationResponseType { constructor: { new(): StartSimulationResponseType }; }
...
export interface StatsValueType extends _StatsValueType { constructor: { new(): StatsValueType }; }

...
export interface DistributionHistogramBin extends _DistributionHistogramBin { constructor: { new(): DistributionHistogramBin }; }
...
interface _DistributionType extends Primitive._string { content: DistributionType; }
...
interface ElementSimulationInfoTypeResourceIdsType extends _ElementSimulationInfoTypeResourceIdsType { constructor: { new(): ElementSimulationInfoTypeResourceIdsType }; }
...
interface ProcessSimulationInfoType_2 extends _ProcessSimulationInfoType_2 { constructor: { new(): ProcessSimulationInfoType_2 }; }

interface _ProcessSimulationInfoTypeElementsType extends BaseType {
	element: ElementSimulationInfoType[];
}
interface ProcessSimulationInfoTypeElementsType extends _ProcessSimulationInfoTypeElementsType { constructor: { new(): ProcessSimulationInfoTypeElementsType }; }
...
interface ProcessSimulationInfoTypeResourcesType extends _ProcessSimulationInfoTypeResourcesType { constructor: { new(): ProcessSimulationInfoTypeResourcesType }; }

interface _ProcessSimulationInfoTypeSequenceFlowsType extends BaseType {
	sequenceFlow: SequenceFlowSimulationInfoType[];
}
interface ProcessSimulationInfoTypeSequenceFlowsType extends _ProcessSimulationInfoTypeSequenceFlowsType { constructor: { new(): ProcessSimulationInfoTypeSequenceFlowsType }; }

interface _ProcessSimulationInfoTypeTimetablesType extends BaseType {
	timetable: TimeTable[];
}
interface ProcessSimulationInfoTypeTimetablesType extends _ProcessSimulationInfoTypeTimetablesType { constructor: { new(): ProcessSimulationInfoTypeTimetablesType }; }
...
export interface Resource extends _Resource { constructor: { new(): Resource }; }
...
export interface SequenceFlowSimulationInfoType extends _SequenceFlowSimulationInfoType { constructor: { new(): SequenceFlowSimulationInfoType }; }
...
export interface TimeTable extends _TimeTable { constructor: { new(): TimeTable }; }
...
export interface TimeTableRule extends _TimeTableRule { constructor: { new(): TimeTableRule }; }
...
interface TimeTableRulesType extends _TimeTableRulesType { constructor: { new(): TimeTableRulesType }; }

/** Weekdays used to define TimeTableRule */
export type WeekDay = ("MONDAY" | "TUESDAY" | "WEDNESDAY" | "THURSDAY" | "FRIDAY" | "SATURDAY" | "SUNDAY");
interface _WeekDay extends Primitive._string { content: WeekDay; }
